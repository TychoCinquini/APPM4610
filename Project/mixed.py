...
for num_points in np.array([5, 10, 25, 50, 100]):
    ...
    wl = fd1.solveLinearSystemMixed(["bottom", "right"])
...
# Save error
np.savetxt('mixed1.csv', error, delimiter=',')
...
for num_points in np.array([5, 10, 25, 50, 100]):
    ...
    wl = fdn.solveLinearSystemMixed(["top", "bottom"])
...
# Save error
np.savetxt('mixed2.csv', error, delimiter=',')